                ...
                <div class="flex content-center mt-4 space-y-8 divide-y divide-gray-200 md:flex-col">
                    <form action="{{ route('admin.menus.update', $menu->id) }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" name="name" value="{{ old('name',$menu->name) }}" id="name" class="w-full rounded-lg @error('name') border-red-500 @enderror">
                                @error('name')
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="">
                                <img src="{{asset('storage/menus/'.$menu->image)}}" alt="" class="w-32 h-20 rounded-md">
                            </div>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea name="description" id="description" cols="10" rows="5" class="block w-full rounded-lg @error('description') border-red-500 @enderror">{{ old('description',$menu->description) }}</textarea>
                                @error('description')
                                    <div class="text-sm text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <select id="categories" name="categories[]" multiple class="block w-full rounded-lg @error('categories') border-red-500 @enderror">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" name="price" value="{{ old('price',$menu->price) }}" id="price" class="block w-full p-2 rounded-lg @error('name') border-red-500 @enderror">
                                @error('price')
                                    <div class="text-sm text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
